...
for p in range(3):
    universe.addParticles(mass=50, size=10, speed=2, elasticity=0.005, colour=(20,40,200))

universe.addSpring(0,1, length=50, strength=5.)
universe.addSpring(1,2, length=50, strength=5.)
universe.addSpring(2,0, length=50, strength=5.)
